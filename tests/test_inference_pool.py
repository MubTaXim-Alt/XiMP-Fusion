...
from ximpfusion import content_analyser, state_manager
from ximpfusion.inference_manager import INFERENCE_POOLS, get_inference_pool
...
def test_get_inference_pool() -> None:
	...
	with patch('ximpfusion.inference_manager.detect_app_context', return_value = 'cli'):
	...
	with patch('ximpfusion.inference_manager.detect_app_context', return_value = 'ui'):
		get_inference_pool('test', model_sources)
