...
from ximpfusion.download import conditional_download_hashes, conditional_download_sources, resolve_download_url_by_provider
...
from ximpfusion.filesystem import in_directory, is_image, is_video, list_directory, resolve_relative_path, same_file_extension
from ximpfusion.processors import choices as processors_choices
from ximpfusion.processors.typing import DeepSwapperInputs, DeepSwapperMorph
from ximpfusion.program_helper import find_argument_group
from ximpfusion.thread_helper import thread_semaphore
from ximpfusion.typing import ApplyStateItem, Args, DownloadScope, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from ximpfusion.vision import conditional_match_frame_color, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		ximpfusion.jobs.job_store.register_step_keys([ 'deep_swapper_model', 'deep_swapper_morph' ])
