...
from ximpfusion import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, process_manager, state_manager, wording
from ximpfusion.face_analyser import get_many_faces, get_one_face
from ximpfusion.face_helper import warp_face_by_face_landmark_5
...
from ximpfusion.filesystem import in_directory, same_file_extension
from ximpfusion.processors import choices as processors_choices
from ximpfusion.processors.typing import FaceDebuggerInputs
from ximpfusion.program_helper import find_argument_group
from ximpfusion.typing import ApplyStateItem, Args, Face, InferencePool, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		ximpfusion.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
