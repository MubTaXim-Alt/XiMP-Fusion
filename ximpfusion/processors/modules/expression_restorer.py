...
from ximpfusion.common_helper import create_int_metavar
from ximpfusion.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from ximpfusion.face_analyser import get_many_faces, get_one_face
from ximpfusion.face_helper import paste_back, warp_face_by_face_landmark_5
from ximpfusion.face_masker import create_occlusion_mask, create_static_box_mask
from ximpfusion.face_selector import find_similar_faces, sort_and_filter_faces
from ximpfusion.face_store import get_reference_faces
from ximpfusion.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from ximpfusion.processors import choices as processors_choices
from ximpfusion.processors.live_portrait import create_rotation, limit_expression
from ximpfusion.processors.typing import ExpressionRestorerInputs
from ximpfusion.processors.typing import LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw
from ximpfusion.program_helper import find_argument_group
from ximpfusion.thread_helper import conditional_thread_semaphore, thread_semaphore
from ximpfusion.typing import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from ximpfusion.vision import get_video_frame, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		ximpfusion.jobs.job_store.register_step_keys([ 'expression_restorer_model','expression_restorer_factor' ])
