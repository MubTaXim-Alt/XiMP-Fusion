...
from ximpfusion.filesystem import get_file_size, is_file, remove_file
from ximpfusion.hash_helper import validate_hash
from ximpfusion.typing import DownloadProvider, DownloadSet
...
def ping_download_provider(download_provider : DownloadProvider) -> bool:
	download_provider_value = ximpfusion.choices.download_provider_set.get(download_provider)
