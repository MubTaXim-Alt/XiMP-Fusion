...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/ximpfusion/ximpfusion-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'url': 'https://huggingface.co',
		'path': '/ximpfusion/{base_name}/resolve/main/{file_name}'
	}
}
