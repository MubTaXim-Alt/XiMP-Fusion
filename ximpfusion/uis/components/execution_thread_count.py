...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(ximpfusion.choices.execution_thread_count_range),
		minimum = ximpfusion.choices.execution_thread_count_range[0],
		maximum = ximpfusion.choices.execution_thread_count_range[-1]
	)
