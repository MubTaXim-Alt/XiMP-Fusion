...
from ximpfusion.typing import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = ximpfusion.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(ximpfusion.choices.system_memory_limit_range),
		minimum = ximpfusion.choices.system_memory_limit_range[0],
		maximum = ximpfusion.choices.system_memory_limit_range[-1],
