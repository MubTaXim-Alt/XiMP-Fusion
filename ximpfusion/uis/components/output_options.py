...
from ximpfusion.common_helper import calc_int_step
from ximpfusion.filesystem import is_image, is_video
from ximpfusion.typing import Fps, OutputAudioEncoder, OutputVideoEncoder, OutputVideoPreset
from ximpfusion.uis.core import get_ui_components, register_ui_component
from ximpfusion.vision import create_image_resolutions, create_video_resolutions, detect_image_resolution, detect_video_fps, detect_video_resolution, pack_resolution
...
def render() -> None:
	...
	OUTPUT_IMAGE_QUALITY_SLIDER = gradio.Slider(
		...
		step = calc_int_step(ximpfusion.choices.output_image_quality_range),
		minimum = ximpfusion.choices.output_image_quality_range[0],
		maximum = ximpfusion.choices.output_image_quality_range[-1],
	...
	OUTPUT_AUDIO_ENCODER_DROPDOWN = gradio.Dropdown(
		...
		choices = ximpfusion.choices.output_audio_encoders,
	...
	OUTPUT_VIDEO_ENCODER_DROPDOWN = gradio.Dropdown(
		...
		choices = ximpfusion.choices.output_video_encoders,
	...
	OUTPUT_VIDEO_PRESET_DROPDOWN = gradio.Dropdown(
		...
		choices = ximpfusion.choices.output_video_presets,
	...
	OUTPUT_VIDEO_QUALITY_SLIDER = gradio.Slider(
		...
		step = calc_int_step(ximpfusion.choices.output_video_quality_range),
		minimum = ximpfusion.choices.output_video_quality_range[0],
		maximum = ximpfusion.choices.output_video_quality_range[-1],
		visible = is_video(state_manager.get_item('target_path'))
	)
