...
from ximpfusion import logger, metadata, state_manager, wording
from ximpfusion.exit_helper import hard_exit
from ximpfusion.filesystem import resolve_relative_path
from ximpfusion.uis.typing import Component, ComponentName
...
def load_ui_layout_module(ui_layout : str) -> Any:
	try:
		ui_layout_module = importlib.import_module('ximpfusion.uis.layouts.' + ui_layout)
...
def get_theme() -> gradio.Theme:
	return gradio.themes.Base(
		primary_hue = gradio.themes.colors.purple,  # Change from red to purple
